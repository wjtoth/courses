...
\paragraph{}
Let $G = (V,E)$ be a metric graph with edge costs $c:E \rightarrow \R_+$ and requirements $r(u,v) \in \N$ for all $u,v \in V$. Consider the following algorithm, $\cA$, for the Generalized Steiner Network (GSN) problem:
\begin{enumerate}
